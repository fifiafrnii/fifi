...
Route::post('/product/create', [ProductController::class, 'store_product'])->name('create_product');
...
Route::patch('/cart/{cart}', [CartController::class, 'update_cart'])->name('update_product');
